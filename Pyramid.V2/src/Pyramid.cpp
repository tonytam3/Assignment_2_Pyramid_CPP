...
long long myPyramidConstructor(long myinitiallevel);
string mySpaceFunc(int maxBaseWidth, long long myPyramidAtLevel);
...
long long myPyramidConstructor(long myinitiallevel) { // Function for constructing pyramid at level
	long n = 1;
	long long myPyramidResult = 0;
	long long myIntermediate = 10;
...
string mySpaceFunc(int maxBaseWidth, long long myPyramidAtLevel) { // Function for putting out space difference between left and right side of pyramid
	int myPyramidCharacterLength = 1;
	long long myRuler = 10;
